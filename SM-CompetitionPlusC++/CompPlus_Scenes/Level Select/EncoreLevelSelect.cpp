...
namespace CompPlus_EncoreLevelSelect
{
    ...
    void SetupMenuPoints()
    {
        ...
        MLS_MenuPoints[0][1] = CreateMenuPoint(0, 1, "SMCP_GHZ1E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 0, false); i++;
        MLS_MenuPoints[0][2] = CreateMenuPoint(0, 2, "SMCP_GHZ2E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 0, false); i++;
        MLS_MenuPoints[0][3] = CreateMenuPoint(0, 3, "SMCP_CPZ1E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 1, false); i++;
        MLS_MenuPoints[0][4] = CreateMenuPoint(0, 4, "SMCP_CPZ2E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 1, false); i++;
        MLS_MenuPoints[0][5] = CreateMenuPoint(0, 5, "SMCP_SPZ1E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 2, false); i++;
        MLS_MenuPoints[0][6] = CreateMenuPoint(0, 6, "SMCP_SPZ2E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 2, false); i++;
        ...
        MLS_MenuPoints[1][1] = CreateMenuPoint(1, 1, "SMCP_FBZ1E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 3, false); i++;
        MLS_MenuPoints[1][2] = CreateMenuPoint(1, 2, "SMCP_FBZ2E", LevelTitles[i], LevelNames[i], AuthorNames[1], 1, 3, false); i++;
        MLS_MenuPoints[1][3] = CreateMenuPoint(1, 3, "SMCP_PGZ1E", LevelTitles[i], LevelNames[i], AuthorNames[1], 1, 4, false); i++;
        MLS_MenuPoints[1][4] = CreateMenuPoint(1, 4, "SMCP_PGZ2E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 4, false); i++;
        MLS_MenuPoints[1][5] = CreateMenuPoint(1, 5, "SMCP_SSZ1E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 5, false); i++;
        MLS_MenuPoints[1][6] = CreateMenuPoint(1, 6, "SMCP_SSZ2E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 5, false); i++;
        ...
        MLS_MenuPoints[2][1] = CreateMenuPoint(2, 1, "SMCP_HCZ1E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 6, false); i++;
        MLS_MenuPoints[2][2] = CreateMenuPoint(2, 2, "SMCP_HCZ2E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 6, false); i++;
        MLS_MenuPoints[2][3] = CreateMenuPoint(2, 3, "SMCP_MSZ1E", LevelTitles[i], LevelNames[i], AuthorNames[2], 1, 7, false); i++;
        MLS_MenuPoints[2][4] = CreateMenuPoint(2, 4, "SMCP_MSZ2E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 7, false); i++;
        MLS_MenuPoints[2][5] = CreateMenuPoint(2, 5, "SMCP_OOZ1E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 8, false); i++;
        MLS_MenuPoints[2][6] = CreateMenuPoint(2, 6, "SMCP_OOZ2E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 8, false); i++;
        MLS_MenuPoints[2][7] = CreateBlankMenuPoint(7, 1);

        MLS_MenuPoints[3][0] = CreateBlankMenuPoint(0, 1);
        MLS_MenuPoints[3][1] = CreateMenuPoint(3, 1, "SMCP_LRZ1E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 9, false); i++;
        MLS_MenuPoints[3][2] = CreateMenuPoint(3, 2, "SMCP_LRZ2E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 9, false); i++;
        MLS_MenuPoints[3][3] = CreateMenuPoint(3, 3, "SMCP_MMZ1E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 10, false); i++;
        MLS_MenuPoints[3][4] = CreateMenuPoint(3, 4, "SMCP_MMZ2E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 10, false); i++;
        MLS_MenuPoints[3][5] = CreateMenuPoint(3, 5, "SMCP_TMZ1E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 11, false); i++;
        MLS_MenuPoints[3][6] = CreateMenuPoint(3, 6, "SMCP_TMZ2E", LevelTitles[i], LevelNames[i], AuthorNames[0], 1, 11, false); i++;
    ...
    void OnDraw()
    {
        ...
        if (!isIconsLoaded)
        {
            IconsSpriteID = LoadAnimation("CP_LSelect/Icons_Encore.bin", Scope_Global);
            isIconsLoaded = true;
            return;
        }
