...
namespace CompPlus_ChaotixLevelSelect
{
	...
	void SetupChaotixLSelectMenuPoints()
	{
		...
		CLS_MenuPoints[0][1] = MenuPoint(startingSlot + 0, "CPCXLS");
		CLS_MenuPoints[0][2] = MenuPoint(startingSlot + 1, "CPCXLS");
		CLS_MenuPoints[0][3] = MenuPoint(startingSlot + 2, "CPCXLS");
		CLS_MenuPoints[0][4] = MenuPoint(startingSlot + 3, "CPCXLS");
		CLS_MenuPoints[0][5] = MenuPoint(startingSlot + 4, "CPCXLS");
		CLS_MenuPoints[0][6] = MenuPoint(startingSlot + 5, "CPCXLS");
		CLS_MenuPoints[0][7] = MenuPoint(true, 7, 1);

		CLS_MenuPoints[1][0] = MenuPoint(CLS_MenuPointLeft, "CPCLS");
		CLS_MenuPoints[1][1] = MenuPoint(startingSlot + 6, "CPCXLS");
		CLS_MenuPoints[1][2] = MenuPoint(startingSlot + 7, "CPCXLS");
		CLS_MenuPoints[1][3] = MenuPoint(startingSlot + 8, "CPCXLS");
		CLS_MenuPoints[1][4] = MenuPoint(startingSlot + 9, "CPCXLS");
		CLS_MenuPoints[1][5] = MenuPoint(startingSlot + 10, "CPCXLS");
